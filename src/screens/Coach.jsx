...
export default function Coach({ history, todayPlan, onBack }) {
  ...
  return (
    <div className="screen screen--slide-in chat-screen">
      <header className="header">
        <button className="ghost-btn" onClick={onBack}>Back</button>
        <div className="brand-sm">COACH CHAT</div>
        <div />
      </header>

      <div className="chat-scroll">
        {messages.length === 0 && (
          <p className="body" style={{ color: 'var(--muted)', marginTop: 20 }}>
            Ask anything mid-workout — the coach knows today's plan, your
