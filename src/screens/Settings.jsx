    ...
    <div className="screen screen--slide-in">
      ...
      <div className="card">
        ...
        <p className="body" style={{ color: 'var(--muted)' }}>
          ...
          <a className="link" href="gym-checkin-v5.shortcut" download>
            Install the Gym Check-in v5 shortcut
          </a>{' '}
          → <b>Add Shortcut</b>
          <br />
          ...
          pick <b>"Gym Check-in v5"</b>. If you reinstall the shortcut later,
